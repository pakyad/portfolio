...
export const projects: Project[] = [
  ...
  },
  {
    ...
    availability: "live",
    liveUrl: "https://rosta.iyadiman.me",
    featured: true,
    problem:
...
export const works: Work[] = [
  {
    ...
    liveUrl: "https://alder.iyadiman.me",
    sourceUrl: "https://github.com/pakyad/alder-roasters",
    description: "A specialty coffee storefront built end to end:catalogue, cart, checkout, brew guides, the whole journey.",
    tier: "featured",
  },
  {
    slug: "pulse",
    ...
    statusLabel: "In Development",
    sourceUrl: "https://github.com/pakyad/pulse",
    description: "Campus marketplace where an AI price check keeps student listings honest.",
    tier: "featured",
  },
  {
    slug: "laterlah",
    ...
    statusLabel: "Unavailable",
    availability: "unavailable",
    sourceUrl: "https://github.com/pakyad/laterlah",
    description: "Save-for-later built around the return, not the save. Deterministic scoring, no AI.",
    tier: "featured",
  },
  {
    slug: "rosta",
    ...
    liveUrl: "https://rosta.iyadiman.me",
    sourceUrl: "https://github.com/pakyad/rosta",
    description: "Shift scheduling for small teams:availability, swaps, time-off, permissions.",
    tier: "featured",
  },
  {
    slug: "blu",
    title: "Blu",
    category: "Visual web experiment",
    year: "2025",
    status: "prototype",
    statusLabel: "Experiment",
    liveUrl: "https://blu.iyadiman.me",
    description: "Visual web experiment. One of the animation pattern studies pulled into Alder.",
    tier: "build",
  },
  {
    slug: "coastline",
    ...
    status: "prototype",
    statusLabel: "Experiment",
    liveUrl: "https://coastline.iyadiman.me",
    description: "Visual web experiment. Motion study feeding the Alder storefront.",
    tier: "build",
  },
  {
    slug: "bazram-merdeka",
    title: "Bazram Merdeka",
    category: "Visual web experiment",
    year: "2025",
    status: "prototype",
    statusLabel: "Experiment",
    liveUrl: "https://bazram-merdeka.iyadiman.me",
    description: "Visual web experiment. An animation pattern exploration for Alder.",
    tier: "build",
  },
];

export const caseStudies = works.filter((w) => w.tier === "featured");
