...
export default function ProjectHero({ project }: { project: Project }) {
  return (
    <section className="project-hero">
      ...
      <div className="grid-row"><div className="grid-col-6"><div className="project-hero-meta"><div className="project-hero-meta-item"><MonoLabel className="project-hero-meta-label">Role</MonoLabel><p className="project-hero-meta-value">{project.role}</p></div></div></div></div>
    </section>
  );
}
